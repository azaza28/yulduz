...
__all__ = [
    'LoadPictureConstants', 'IPictureDisp', 'IFontDisp', 'Gray',
    'Monochrome', 'FONTSTRIKETHROUGH', 'Unchecked',
    'OLE_YSIZE_HIMETRIC', 'OLE_XSIZE_HIMETRIC', 'FONTNAME',
    'OLE_YSIZE_PIXELS', 'VgaColor', 'Picture', 'OLE_YPOS_PIXELS',
    'OLE_XSIZE_CONTAINER', 'OLE_TRISTATE', 'OLE_YPOS_HIMETRIC',
    'OLE_ENABLEDEFAULTBOOL', 'IPicture', 'Color', 'OLE_XPOS_PIXELS',
    'FONTITALIC', 'Font', 'FONTSIZE', 'OLE_YSIZE_CONTAINER',
    'StdFont', 'FontEvents', 'OLE_CANCELBOOL', 'IFontEventsDisp',
    'IFont', 'OLE_COLOR', 'OLE_YPOS_CONTAINER', 'Default', 'FONTBOLD',
    'StdPicture', 'OLE_HANDLE', 'OLE_OPTEXCLUSIVE', 'FONTUNDERSCORE',
    'OLE_XPOS_CONTAINER', 'OLE_XPOS_HIMETRIC', 'OLE_XSIZE_PIXELS',
    'Checked'
]

_check_version('1.2.1', 1575709685.550032)
