...
__all__ = [
    'eLEXTYPE_PRIVATE10', 'DISPID_SBSRead', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SRGCmdLoadFromObject', 'SASClosed',
    'DISPID_SVSLastBookmarkId', 'SPPS_Modifier', 'DISPID_SVSpeak',
    'WAVEFORMATEX', 'DISPID_SOTDataKey', 'SREHypothesis',
    'SpeechCategoryPhoneConverters', 'ISpeechGrammarRules',
    'SAFTDefault', 'DISPID_SABIEventBias', 'SECLowConfidence',
    'SAFT16kHz16BitStereo', 'SAFT22kHz16BitMono',
    'SpPhoneticAlphabetConverter', 'DISPID_SpeechAudioStatus',
    'SpeechGrammarTagDictation', 'DISPID_SWFEBitsPerSample',
    'DISPID_SPRText', 'DISPID_SRGetPropertyNumber',
    'SPDKL_CurrentUser', 'SVSFNLPMask', 'SGRSTTEpsilon',
    'SpMemoryStream', 'SpPhoneConverter', 'DISPID_SPPConfidence',
    'SVEWordBoundary', 'ISpeechCustomStream',
    'SpeechRecoProfileProperties', 'DISPID_SDKSetBinaryValue',
    'DISPID_SRCERecognizerStateChange', 'SpeechFormatType',
    'DISPID_SpeechVoiceEvent', 'DISPID_SOTCreateInstance',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SPACommit',
    'SPWORDPRONUNCIATION', 'ISpeechVoiceStatus', 'eLEXTYPE_PRIVATE12',
    'SAFT8kHz16BitMono', 'SAFT48kHz8BitMono',
    'DISPID_SPRuleConfidence', 'eWORDTYPE_DELETED',
    'DISPID_SRGCmdSetRuleIdState', 'SVSFParseAutodetect',
    'DISPID_SVEventInterests', 'SPCT_COMMAND',
    'DISPID_SpeechLexiconProns', 'DISPID_SpeechRecoContextEvents',
    'SAFT48kHz16BitMono', '_ISpeechRecoContextEvents',
    'SPEI_RESERVED6', 'SAFTCCITT_ALaw_11kHzStereo',
    'SpPhraseInfoBuilder', 'DISPID_SRRGetXMLErrorInfo',
    'SPEI_HYPOTHESIS', 'SpeechRunState', 'SpObjectTokenCategory',
    'SAFTADPCM_44kHzMono', 'DISPID_SRCEventInterests',
    'eLEXTYPE_PRIVATE20', 'ISpRecoCategory',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SGRsAdd',
    'DISPID_SVSVisemeId', 'DISPID_SpeechPhraseElements',
    'DISPID_SRGetRecognizers', 'DISPID_SPEs_NewEnum',
    'ISpeechGrammarRuleState', 'SAFT8kHz8BitStereo',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'ISpeechPhraseRules',
    'SPEI_UNDEFINED', 'DISPID_SRGId', 'DISPID_SCSBaseStream',
    'SGLexicalNoSpecialChars', 'ISpeechPhoneConverter',
    'SPGRAMMARSTATE', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SOTIsUISupported',
    'SpeechTokenKeyUI', 'SECNormalConfidence', 'SPRS_INACTIVE',
    'DISPID_SpeechVoiceStatus', 'SpeechWordPronounceable',
    'DISPID_SRIsUISupported', 'SGDSActiveWithAutoPause', 'SWTDeleted',
    'SRESoundStart', 'SPPHRASEREPLACEMENT', 'SpeechRuleAttributes',
    'SpeechVoiceSkipTypeSentence', 'ISpeechRecoResultDispatch',
    'SPFM_CREATE_ALWAYS', 'SPEI_SR_AUDIO_LEVEL',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SRRTOffsetFromStart',
    'SGRSTTTextBuffer', 'eLEXTYPE_PRIVATE3', 'SDTAlternates',
    'Speech_Default_Weight', 'Speech_Max_Word_Length',
    'DISPIDSPTSI_SelectionLength', 'SPSTREAMFORMATTYPE',
    'DISPID_SRAudioInputStream', 'SPPHRASE', 'SPEI_SR_RETAINEDAUDIO',
    'ISpeechRecoGrammar', 'SP_VISEME_12', 'DISPID_SpeechGrammarRules',
    'SpUnCompressedLexicon', 'SINoSignal', 'eLEXTYPE_RESERVED10',
    'DISPID_SPPsCount', 'SRSActive', 'eLEXTYPE_PRIVATE4', 'SLOStatic',
    'SAFT44kHz8BitMono', 'DISPID_SAEventHandle',
    'SpeechEmulationCompareFlags', 'SP_VISEME_18',
    'DISPID_SWFEFormatTag', 'SPSInterjection', 'SPGS_DISABLED',
    'DISPID_SLWsCount', 'SPEI_VISEME', 'ISpeechWaveFormatEx',
    'SpeechPropertyComplexResponseSpeed', 'SITooFast', 'SASPause',
    'DISPID_SRCESoundStart', 'SGDSActive',
    'SpeechGrammarTagUnlimitedDictation', 'SpeechVoicePriority',
    'SpeechRecoEvents', 'SPPS_RESERVED4', 'DISPIDSPRG',
    'DISPID_SRRPhraseInfo', 'DISPID_SRCEStartStream',
    'DISPID_SpeechVoice', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SPCPhoneToId', 'SDTAudio', 'SPSNoun', 'SPEI_SOUND_END',
    'SVSFlagsAsync', 'ISpeechAudioStatus', 'SRESoundEnd',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SRGDictationSetState',
    'ISpeechPhraseReplacement', 'SPWF_SRENGINE', 'SPSModifier',
    'SAFT22kHz8BitStereo', 'SVP_5', 'SpeechRecognizerState',
    'SPEI_RECOGNITION', 'DISPID_SVIsUISupported',
    'DISPIDSPTSI_ActiveOffset', 'SPVPRIORITY',
    'DISPID_SpeechPhraseAlternates', 'SVSFParseMask',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SPIEnginePrivateData',
    'SPEI_RECO_OTHER_CONTEXT', 'SPEI_VOICE_CHANGE', 'SREAdaptation',
    'SVEAllEvents', 'DISPID_SRRTTickCount', 'DISPID_SGRs_NewEnum',
    'SWPUnknownWordPronounceable', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SRRSetTextFeedback', 'SITooQuiet', 'SRSInactiveWithPurge',
    'DISPID_SRCCreateGrammar', 'SpObjectToken',
    'SPINTERFERENCE_NOISE', 'SPEVENTSOURCEINFO',
    'SpeechPropertyAdaptationOn', 'DISPID_SGRSRule',
    'DISPID_SRGRules', 'SpeechCategoryAudioIn', 'SpeechDiscardType',
    'SAFTTrueSpeech_8kHz1BitMono', 'ISpRecoResult', 'SSFMOpenForRead',
    'eLEXTYPE_RESERVED4', 'DISPID_SWFESamplesPerSec',
    'SpeechCategoryAppLexicons', 'DISPID_SPEsCount',
    'DISPID_SLPsItem', 'SPEI_ADAPTATION', 'SPBO_PAUSE',
    'DISPID_SLPPartOfSpeech', 'SREStateChange', 'eLEXTYPE_PRIVATE13',
    'SPEI_PROPERTY_STRING_CHANGE', 'SpeechCategoryRecoProfiles',
    'DISPID_SpeechGrammarRule', 'DISPID_SVVoice', 'DISPID_SAFGuid',
    'SAFTADPCM_8kHzMono', 'DISPID_SRGetFormat', 'ISpeechPhraseRule',
    'DISPID_SVGetVoices', 'SpeechAudioFormatType', 'SVP_11',
    'DISPID_SRCEAdaptation', 'SPSHORTCUTTYPE', 'DISPID_SRProfile',
    'SpeechAudioVolume', 'DISPID_SPRuleEngineConfidence',
    'SpCompressedLexicon', 'SPEI_START_SR_STREAM',
    'SPRECORESULTTIMES', 'DISPID_SPPId', 'DISPID_SMSGetData',
    'DISPID_SGRsCommitAndSave', 'SVSFUnusedFlags',
    'DISPID_SpeechPhoneConverter', 'SPPS_Unknown', 'DISPID_SPIRule',
    'DISPID_SPPName', 'SP_VISEME_16', 'DISPID_SpeechFileStream',
    'SAFT32kHz8BitMono', 'SpeechRecognitionType', 'SREAudioLevel',
    'DISPID_SRState', 'DISPID_SRCPause', 'SpSharedRecoContext',
    'SVP_4', 'eLEXTYPE_APP', 'DISPID_SPEAudioSizeBytes', 'SPAS_PAUSE',
    'DISPID_SPRDisplayAttributes', 'SP_VISEME_17',
    'DISPID_SPPFirstElement', 'DISPID_SLWPronunciations',
    'SpeechLexiconType', 'DISPID_SWFEChannels', 'SAFT44kHz16BitMono',
    'DISPID_SPPsItem', 'SPEI_MIN_TTS', 'SpeechRuleState',
    'DISPID_SADefaultFormat', 'SREAllEvents', 'SGRSTTDictation',
    'DISPID_SVEAudioLevel', 'SAFT12kHz16BitMono',
    'DISPID_SRCEAudioLevel', 'DISPIDSPTSI', 'SAFTADPCM_22kHzMono',
    'DISPID_SMSALineId', 'SpeechSpecialTransitionType',
    'DISPID_SVAlertBoundary', 'DISPID_SVResume', 'SPEI_REQUEST_UI',
    'SECFIgnoreWidth', 'DISPID_SVSInputWordLength', 'SRSEDone',
    'SPINTERFERENCE_NONE', 'SPBO_AHEAD', 'SVPAlert',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SpeechPhraseRule',
    'ISpRecoContext2', 'SAFTGSM610_22kHzMono', 'SVEVoiceChange',
    'SVSFDefault', 'SpeechVoiceSpeakFlags', 'SVPNormal', 'SRAExport',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'ISequentialStream', 'SFTInput',
    'SRADefaultToActive', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SWFEBlockAlign', 'SPLOADOPTIONS', 'SVSFIsFilename',
    'DISPID_SOTsItem', 'ISpeechLexiconWord', 'SPRS_ACTIVE',
    'SAFT24kHz16BitStereo', 'SRERecoOtherContext',
    'SREPropertyNumChange', 'DISPID_SPPNumberOfElements',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SRDisplayUI',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SLRemovePronunciation', 'SAFTADPCM_22kHzStereo',
    'SPEI_PHONEME', 'DISPID_SGRSTransitions', 'SAFTGSM610_11kHzMono',
    'SVP_15', 'ISpeechMMSysAudio', 'SPSHT_EMAIL', 'DISPID_SAFType',
    'SpeechInterference', 'DISPID_SGRAddResource', 'STSF_AppData',
    'DISPID_SPIGrammarId', 'SP_VISEME_3', 'ISpNotifySource',
    'SPSHT_OTHER', 'SAFT11kHz16BitMono', 'DISPID_SGRsCount',
    'SP_VISEME_15', 'DISPID_SVVolume', 'SPINTERFERENCE_TOOSLOW',
    'SAFT44kHz8BitStereo', 'DISPID_SMSADeviceId',
    'SAFTCCITT_ALaw_22kHzStereo', 'SP_VISEME_7', 'SPCT_SUB_DICTATION',
    'DISPID_SPEAudioTimeOffset', 'SREStreamEnd',
    'ISpeechPhraseAlternates', 'DISPID_SpeechMemoryStream',
    'SPDATAKEYLOCATION', 'SGDSActiveUserDelimited',
    'SpeechAudioFormatGUIDWave', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SpeechPhraseRules', 'DISPID_SRCState',
    'DISPID_SRRAudioFormat', 'SDKLCurrentUser',
    'DISPID_SRGCmdSetRuleState', 'SVP_17', 'SPSEMANTICERRORINFO',
    'DISPID_SDKGetBinaryValue', 'DISPID_SPIEngineId',
    'DISPID_SASCurrentSeekPosition', 'SPAO_NONE', 'ISpSerializeState',
    'SVP_6', 'SpeechStreamFileMode', 'SVP_21', 'SGSExclusive',
    'SPINTERFERENCE_LATENCY_WARNING', 'SDA_One_Trailing_Space',
    'ISpeechRecoContext', 'STCLocalServer', 'SFTSREngine',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SVWaitUntilDone',
    'DISPID_SDKSetStringValue', 'SP_VISEME_6', 'SREPrivate',
    'DISPID_SRCERecognitionForOtherContext',
    'SPRS_ACTIVE_USER_DELIMITED', 'SAFT24kHz16BitMono',
    'DISPID_SOTCDefault', 'DISPID_SpeechBaseStream',
    'DISPID_SPAsItem', 'SPEI_WORD_BOUNDARY', 'SSTTWildcard',
    'SpStreamFormatConverter', 'SpeechDisplayAttributes',
    'SVEEndInputStream', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'eLEXTYPE_PRIVATE1', 'SAFT16kHz8BitStereo', 'ISpRecognizer2',
    'SpLexicon', 'DISPID_SRCRetainedAudio',
    'SPRST_INACTIVE_WITH_PURGE', 'SPAR_Medium', 'SPRECOCONTEXTSTATUS',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SLGetWords',
    'SAFTNoAssignedFormat', 'SRTEmulated',
    'DISPID_SVSyncronousSpeakTimeout', 'SPPS_NotOverriden',
    'DISPID_SpeechWaveFormatEx', 'IInternetSecurityManager',
    'SP_VISEME_11', 'DISPID_SRCERequestUI', 'SPAUDIOSTATUS',
    'DISPID_SBSWrite', 'SPEVENTENUM', 'SAFTCCITT_uLaw_44kHzMono',
    'ISpeechAudio', 'DISPID_SVSRunningState', 'eLEXTYPE_PRIVATE11',
    'SDTLexicalForm', 'DISPID_SLAddPronunciationByPhoneIds',
    'SpeechCategoryVoices', 'SVPOver', 'DISPID_SPPValue',
    'SPSMF_SAPI_PROPERTIES', 'SPGS_ENABLED', 'SPEI_MAX_TTS',
    'SpeechStreamSeekPositionType', 'STCRemoteServer', 'SVF_Stressed',
    'ISpeechPhraseElement', 'DISPID_SpeechXMLRecoResult', 'SVP_19',
    'SAFT8kHz16BitStereo', 'SPEI_SR_PRIVATE', 'SPVPRI_ALERT',
    'SpeechAllElements', 'SPAS_CLOSED', 'SVP_9',
    'DISPID_SABufferNotifySize', 'SP_VISEME_2', 'SRAInterpreter',
    'SpeechPartOfSpeech', 'DISPID_SPIAudioSizeBytes', 'SpVoice',
    'DISPID_SRCAudioInInterferenceStatus', 'SpeechBookmarkOptions',
    'DISPID_SOTDisplayUI', 'SECFIgnoreCase',
    'DISPID_SPPEngineConfidence', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SDKDeleteKey', 'SPSHT_Unknown', 'DISPID_SOTCId',
    'ISpeechPhraseInfo', 'DISPID_SOTGetDescription', 'SVSFVoiceMask',
    'DISPID_SRCERecognition', 'SPAR_High',
    'ISpeechPhraseReplacements', 'DISPID_SMSAMMHandle',
    'eLEXTYPE_RESERVED6', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SLPLangId', 'SECFIgnoreKanaType', 'SVEPrivate',
    'DISPID_SASFreeBufferSpace', 'ISpRecoGrammar2',
    'DISPID_SPEAudioSizeTime', 'ISpeechLexiconPronunciation',
    'SREPropertyStringChange', 'ISpProperties', 'SLTUser',
    'DISPID_SLPsCount', 'DISPID_SpeechRecoResult',
    'ISpObjectTokenCategory', 'DISPID_SDKEnumValues',
    'DISPID_SOTRemove', 'DISPID_SPRs_NewEnum',
    'DISPID_SGRSTPropertyId', 'SBOPause',
    'ISpPhoneticAlphabetConverter', 'SPEI_TTS_PRIVATE',
    'DISPID_SpeechRecoContext', 'SPPS_Interjection',
    'SAFT48kHz8BitStereo', 'SpeechLoadOption', 'SPWORDPRONOUNCEABLE',
    'SPEI_INTERFERENCE', 'SRCS_Enabled', 'SDKLDefaultLocation',
    'DISPID_SOTCGetDataKey', 'eLEXTYPE_USER', 'DISPID_SRCESoundEnd',
    'SAFT32kHz16BitStereo', 'eLEXTYPE_RESERVED8', 'SPPS_RESERVED2',
    'SGSEnabled', 'DISPID_SDKEnumKeys', 'ISpeechRecognizerStatus',
    'SWTAdded', 'DISPID_SPRulesCount', '__MIDL_IWinTypes_0009',
    'eLEXTYPE_PRIVATE7', 'ISpVoice', 'SPDKL_DefaultLocation',
    'SPBO_NONE', 'ISpPhoneConverter', 'DISPID_SRRRecoContext',
    'DISPID_SPIAudioSizeTime', 'SPRST_ACTIVE', '_RemotableHandle',
    'DISPID_SRIsShared', 'SRERequestUI', 'SP_VISEME_14',
    'SDTDisplayText', 'SpMMAudioEnum', 'DISPID_SGRAddState',
    'ISpStream', 'DISPID_SVEPhoneme', 'SPVISEMES', 'SPEI_SOUND_START',
    'DISPID_SGRSTsCount', 'DISPID_SRSetPropertyNumber',
    'SAFT48kHz16BitStereo', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SGRsFindRule', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SPAS_RUN', 'SPWORDLIST', 'ISpShortcut', 'SPSEMANTICFORMAT',
    'SPINTERFERENCE_NOSIGNAL', 'Speech_StreamPos_RealTime',
    'DISPID_SPCLangId', 'SPFILEMODE', 'SAFT11kHz8BitMono',
    'DISPID_SLWsItem', 'SpWaveFormatEx',
    'DISPID_SpeechObjectTokenCategory', 'LONG_PTR',
    'eLEXTYPE_LETTERTOSOUND', 'SP_VISEME_10', 'DISPID_SpeechAudio',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SPIAudioStreamPosition',
    'SPEI_TTS_AUDIO_LEVEL', 'SAFTCCITT_ALaw_8kHzStereo',
    'SAFT8kHz8BitMono', 'DISPID_SLGenerationId', 'eLEXTYPE_PRIVATE8',
    'DISPID_SVStatus', 'DISPID_SPRFirstElement', 'DISPID_SFSOpen',
    'SLODynamic', 'SAFT24kHz8BitStereo',
    'DISPID_SpeechPhraseProperties', 'STCAll', 'SPPS_RESERVED1',
    'DISPID_SRCEFalseRecognition', 'SpeechCategoryAudioOut',
    'SRATopLevel', 'SPRULE', 'DISPID_SPILanguageId',
    'DISPID_SRRTimes', 'DISPID_SLWLangId', 'DISPID_SASState',
    'DISPID_SOTGetStorageFileName', 'STSF_FlagCreate', 'SVP_10',
    'SRAONone', 'DISPID_SVSpeakStream', 'SpeechGrammarWordType',
    'SPWT_DISPLAY', 'SPDKL_CurrentConfig', 'DISPID_SOTCategory',
    'DISPID_SVSkip', 'SREStreamStart', 'DISPID_SRRSaveToMemory',
    'ISpStreamFormatConverter', 'SP_VISEME_20',
    'DISPID_SRGCmdLoadFromMemory', 'SGSDisabled', 'SASStop',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SRRTLength', 'SPWF_INPUT', 'DISPID_SOTGetAttribute',
    'SPINTERFERENCE_TOOFAST', 'SREBookmark', 'ISpObjectWithToken',
    'SECFEmulateResult', 'SRTStandard', 'ISpMMSysAudio',
    'DISPID_SVRate', 'DISPID_SPAsCount', 'SpeechVisemeType', 'SVP_3',
    'SINoise', 'SRSActiveAlways',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SP_VISEME_5',
    'SP_VISEME_19', 'DISPID_SAStatus', 'DISPID_SRGIsPronounceable',
    'SAFT22kHz16BitStereo', 'SPWORDPRONUNCIATIONLIST', 'SPAUDIOSTATE',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'ISpRecognizer',
    'ISpeechRecoResultTimes', 'SPPARTOFSPEECH',
    'SAFTCCITT_uLaw_11kHzMono', 'SPAUDIOOPTIONS',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SWFEExtraData',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SDKDeleteValue',
    'DISPID_SPEActualConfidence', 'IStream', 'SPRECOGNIZERSTATUS',
    'DISPID_SRCBookmark', 'SAFT11kHz16BitStereo',
    'eLEXTYPE_PRIVATE14', 'SPSVerb', 'SPXMLRESULTOPTIONS',
    'SVEBookmark', 'SSTTDictation', 'SPSLMA', 'SPXRO_SML', 'SPPS_LMA',
    'SpInprocRecognizer', 'DISPID_SVGetAudioOutputs',
    'SpeechAudioState', 'DISPID_SVEEnginePrivate',
    'DISPID_SPIElements', 'ISpPhrase', 'eLEXTYPE_RESERVED9',
    'SPEI_END_SR_STREAM', 'SpeechDataKeyLocation',
    'SAFT44kHz16BitStereo', 'SVSFIsXML', 'DISPID_SLWs_NewEnum',
    'ISpeechVoice', 'SPSUnknown', 'DISPID_SLPType',
    'DISPID_SGRAttributes', 'SPSERIALIZEDRESULT', 'SPRULESTATE',
    'SpeechMicTraining', 'SPBOOKMARKOPTIONS', 'DISPID_SLPSymbolic',
    'tagSTATSTG', 'DISPID_SpeechLexiconPronunciation',
    'eLEXTYPE_PRIVATE9', 'SAFTCCITT_ALaw_44kHzMono', 'SVP_0',
    'DISPID_SVEStreamEnd', 'SRTReSent', 'ISpObjectToken',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'DISPID_SOTId',
    'DISPID_SPELexicalForm', 'SAFTExtendedAudioFormat',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SpeechDataKey',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPCT_SUB_COMMAND',
    'DISPID_SGRSTRule', 'ISpResourceManager', 'SAFTText',
    'DISPID_SRCEEndStream', 'SpMMAudioOut', 'DISPID_SOTsCount',
    'SRERecognition', 'DISPID_SPRsItem', 'DISPID_SABIMinNotification',
    'DISPID_SRCRequestedUIType', 'SpeechRegistryUserRoot',
    'SPSHORTCUTPAIRLIST', 'DISPID_SASetState',
    'DISPID_SpeechLexiconWords', 'DISPID_SVEViseme',
    'SPEI_SR_BOOKMARK', 'eLEXTYPE_RESERVED7', 'ISpLexicon',
    'SDA_Consume_Leading_Spaces', 'ISpeechAudioFormat',
    'ISpeechRecognizer', 'SPAS_STOP', 'SAFTADPCM_11kHzMono',
    'DISPID_SVSLastResult', 'DISPID_SpeechRecoResult2', 'SLTApp',
    'ISpeechLexiconPronunciations', 'SPTEXTSELECTIONINFO', 'SDTAll',
    'DISPID_SGRSAddWordTransition', 'SpCustomStream',
    'SAFT22kHz8BitMono', 'SPDKL_LocalMachine',
    'DISPID_SpeechAudioFormat', 'DISPID_SVSPhonemeId',
    'DISPID_SpeechPhraseAlternate', 'SPINTERFERENCE',
    'SSFMCreateForWrite', 'IEnumString',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SASNonBlockingIO',
    'SpeechRecoContextState', 'DISPID_SVAudioOutputStream',
    'DISPID_SRRecognizer', 'DISPID_SRRAudio',
    'ISpeechPhraseProperties', 'DISPID_SLWWord',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPEI_START_INPUT_STREAM',
    'SVSFIsNotXML', 'SVEAudioLevel', 'SpeechAudioProperties',
    'DISPID_SRCVoice', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SPRuleName', 'SAFTGSM610_44kHzMono', 'SPCATEGORYTYPE',
    'SECHighConfidence', 'SpeechGrammarState', 'DISPID_SVGetProfiles',
    'DISPID_SLGetPronunciations', '_ISpeechVoiceEvents',
    'DISPID_SPIProperties', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SRAORetainAudio', 'DISPID_SPRuleChildren',
    'DISPID_SRGSetTextSelection', 'DISPID_SRCResume',
    'DISPID_SOTRemoveStorageFileName', 'SpSharedRecognizer',
    'SP_VISEME_21', 'SPEI_PHRASE_START', 'SPFM_CREATE',
    'SPXRO_Alternates_SML', 'tagSPPROPERTYINFO', 'SPRECOSTATE',
    'SVP_8', 'SRTSMLTimeout', 'SpeechPropertyHighConfidenceThreshold',
    'SP_VISEME_9', 'SAFTCCITT_uLaw_22kHzMono', 'SP_VISEME_0',
    'SITooSlow', 'SRSInactive', 'DISPID_SGRsCommit',
    'DISPID_SpeechRecognizer', 'SPPS_Noun', 'SRTAutopause',
    'SPEI_MIN_SR', 'SITooLoud', 'SPBO_TIME_UNITS',
    'SpInProcRecoContext', 'IEnumSpObjectTokens', 'SPSMF_UPS',
    'DISPID_SDKGetStringValue', 'SVSFPersistXML',
    'eLEXTYPE_PRIVATE15', 'SPEVENT', 'ISpeechBaseStream',
    'SDKLCurrentConfig', 'eLEXTYPE_PRIVATE17',
    'SAFTNonStandardFormat', 'DISPID_SPPChildren', 'SPAR_Low',
    'DISPID_SPARecoResult', 'SGRSTTRule', 'ISpRecoGrammar',
    'DISPID_SVEBookmark', 'DISPID_SPIStartTime', 'SPWT_LEXICAL',
    'IInternetSecurityMgrSite', 'eWORDTYPE_ADDED',
    'SPFM_OPEN_READONLY', 'SAFT12kHz8BitStereo', 'SAFT32kHz16BitMono',
    'DISPID_SRGReset', 'SGRSTTWord', 'SpeechEngineConfidence',
    'ISpeechTextSelectionInformation', 'SPFM_NUM_MODES',
    'DISPID_SLGetGenerationChange', 'DISPID_SGRSTsItem',
    'SWPUnknownWordUnpronounceable', 'SECFNoSpecialChars',
    'SpeechVisemeFeature', 'DISPID_SPEPronunciation',
    'SREInterference', 'SRTExtendableParse', 'DISPID_SGRClear',
    'DISPIDSPTSI_ActiveLength', 'ISpeechFileStream',
    'SPSERIALIZEDPHRASE', 'UINT_PTR', 'SPEI_RESERVED5',
    'SPEI_RESERVED3', 'DISPID_SVPriority',
    'DISPID_SPERequiredConfidence', 'DISPID_SPRulesItem',
    'SPAR_Unknown', 'DISPID_SRAudioInput', 'SPSNotOverriden',
    'SGDSInactive', 'ISpeechObjectTokenCategory',
    'SpeechTokenKeyFiles', 'ISpeechLexiconWords',
    'DISPID_SVESentenceBoundary', 'SVP_7', 'SAFT16kHz16BitMono',
    'SVP_1', 'SSFMOpenReadWrite', 'DISPID_SRCEHypothesis',
    'STCInprocHandler', 'DISPID_SVSInputWordPosition',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SRRTStreamTime',
    'SpTextSelectionInformation', 'ISpNotifyTranslator',
    'DISPID_SRStatus', 'DISPID_SPEDisplayText', 'ISpXMLRecoResult',
    'SPCT_SLEEP', 'SpeechGrammarTagWildcard',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SGRSTPropertyValue',
    'SPEI_SENTENCE_BOUNDARY', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SpeechObjectTokens', 'DISPID_SPRNumberOfElements',
    'SAFTADPCM_44kHzStereo', 'ISpStreamFormat', 'SGRSTTWildcard',
    'ISpeechMemoryStream', 'ISpeechObjectTokens', 'SPSFunction',
    'SPWORDTYPE', 'DISPID_SRGSetWordSequenceData', 'SPVPRI_OVER',
    'SPLEXICONTYPE', 'SAFTGSM610_8kHzMono', 'SDTReplacement',
    'STSF_CommonAppData', 'SPPS_Noncontent', 'ISpeechLexicon',
    'DISPID_SGRInitialState', 'DISPID_SpeechLexicon',
    'eLEXTYPE_PRIVATE5', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SAFSetWaveFormatEx', 'SGPronounciation',
    'SPAO_RETAIN_AUDIO', 'DISPID_SOTMatchesAttributes',
    'eLEXTYPE_PRIVATE6', 'SDTProperty', 'SDTPronunciation',
    'SVSFPurgeBeforeSpeak', 'SPSHT_NotOverriden', 'SPCT_DICTATION',
    'DISPID_SPCIdToPhone', 'eLEXTYPE_PRIVATE16', 'SPPS_Verb',
    'DISPID_SRGetPropertyString',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SP_VISEME_13',
    'DISPID_SPPParent', 'DISPID_SpeechMMSysAudio',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SRCRecognizer',
    'SPSHORTCUTPAIR', 'ISpeechObjectToken',
    'DISPID_SRCEPropertyStringChange', 'SAFTCCITT_ALaw_11kHzMono',
    'SpeechRetainedAudioOptions', 'DISPID_SGRSTType',
    'SPAUDIOBUFFERINFO', 'Speech_StreamPos_Asap',
    'DISPID_SRSSupportedLanguages', 'SPPS_Function',
    'SPEI_FALSE_RECOGNITION', 'SVP_16', 'DISPID_SRCSetAdaptationData',
    'DISPID_SGRSTText', 'SSSPTRelativeToEnd', 'DISPID_SPRuleId',
    'SVP_20', 'DISPID_SVAudioOutput', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SPEDisplayAttributes',
    'SpeechPropertyLowConfidenceThreshold', 'SPWORD',
    'DISPID_SRGRecoContext', 'DISPID_SpeechLexiconWord',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPCS_ENABLED', 'DISPID_SFSClose',
    'DISPID_SVSInputSentencePosition', 'SpeechPropertyResourceUsage',
    'SPGRAMMARWORDTYPE', 'SAFT12kHz8BitMono', 'SAFT11kHz8BitStereo',
    'DISPID_SVEStreamStart', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SpeechTokenShellFolder', 'ISpeechPhraseElements',
    'SPRST_NUM_STATES', 'DISPID_SRCEEnginePrivate', 'SRSEIsSpeaking',
    'DISPID_SVPause', 'DISPID_SpeechObjectToken',
    'SAFTADPCM_8kHzStereo', 'DISPID_SPIReplacements',
    'DISPID_SRGDictationLoad', 'SVESentenceBoundary',
    'SpeechAddRemoveWord', 'SAFTCCITT_uLaw_8kHzMono',
    'Speech_Max_Pron_Length', 'SREFalseRecognition',
    'SWPKnownWordPronounceable', 'DISPID_SRRAlternates',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SPAStartElementInResult',
    'DISPID_SRCEBookmark', 'DISPID_SRSetPropertyString',
    'SPEI_RESERVED2', 'DISPID_SLAddPronunciation', 'SPRST_INACTIVE',
    'DISPID_SGRsDynamic', 'DISPID_SLPPhoneIds',
    'DISPID_SpeechPhraseElement', 'DISPID_SPRuleParent',
    'DISPID_SRCreateRecoContext', 'SP_VISEME_8',
    'SpeechPropertyResponseSpeed', 'SREPhraseStart', 'SPVOICESTATUS',
    'DISPID_SABIBufferSize', 'ISpeechRecoResult2',
    'DISPID_SpeechPhraseProperty', 'ISpeechDataKey',
    'DISPID_SVSCurrentStreamNumber', 'SPPHRASERULE', 'SBONone',
    'DISPID_SOTSetId', 'SDTRule', 'DISPID_SRRSpeakAudio',
    'SPCS_DISABLED', 'DISPID_SDKOpenKey', 'DISPID_SGRSTWeight',
    'DISPID_SDKGetlongValue', 'SGLexical', 'SpMMAudioIn',
    'DISPID_SASCurrentDevicePosition',
    'DISPID_SRCEPropertyNumberChange', 'SRARoot',
    'DISPID_SRGCmdLoadFromFile', 'SAFTCCITT_uLaw_22kHzStereo',
    'SDA_Two_Trailing_Spaces', 'SpNullPhoneConverter',
    'DISPID_SPEAudioStreamOffset', 'SPBINARYGRAMMAR',
    'SAFTADPCM_11kHzStereo', 'DISPID_SLWType',
    'DISPID_SPEEngineConfidence', 'ISpDataKey',
    'DISPID_SpeechPhraseReplacement', 'SSTTTextBuffer',
    'DISPID_SBSSeek', 'ISpNotifySink', 'ISpeechAudioBufferInfo',
    'ISpEventSink', 'ISpPhraseAlt', 'SPPHRASEELEMENT',
    'DISPID_SGRSTNextState', 'SPWT_PRONUNCIATION',
    'SpeechTokenValueCLSID', 'SpeechEngineProperties',
    'DISPID_SpeechPhraseBuilder', 'SVP_14', 'SVSFParseSsml',
    'SpeechDictationTopicSpelling', 'SPEI_TTS_BOOKMARK', 'SVP_2',
    'SPFM_OPEN_READWRITE', 'ISpAudio', 'DISPID_SPAPhraseInfo',
    'SGDisplay', 'SAFT12kHz16BitStereo', 'DISPID_SRCEInterference',
    'SASRun', 'STSF_LocalAppData', 'SSSPTRelativeToStart',
    'SVSFParseSapi', 'SVEStartInputStream',
    'SpeechTokenIdUserLexicon', 'SpShortcut', 'DISPID_SRSClsidEngine',
    'SPADAPTATIONRELEVANCE',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SLPs_NewEnum',
    'DISPID_SRSAudioStatus', 'SDA_No_Trailing_Space',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SPAs_NewEnum',
    'SPLO_DYNAMIC', 'DISPID_SPISaveToMemory', 'SPWAVEFORMATTYPE',
    'SVP_12', 'SRCS_Disabled', 'SVEPhoneme', 'SINone',
    'DISPID_SPRsCount', 'DISPID_SPPs_NewEnum',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SGRId', 'SpeechCategoryRecognizers', 'SpStream',
    'DISPID_SOTCSetId', 'ISpeechRecoResult', 'DISPID_SABufferInfo',
    'ISpeechResourceLoader', 'DISPID_SpeechCustomStream',
    'SECFDefault', 'ISpRecoContext', 'SPVPRI_NORMAL',
    'ISpRecognizer3', 'SPGS_EXCLUSIVE', 'SPPHRASEPROPERTY',
    'DISPID_SVSLastBookmark', 'SpeechUserTraining', 'SRAImport',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SAFTCCITT_ALaw_22kHzMono', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SRGDictationUnload', 'DISPID_SRRGetXMLResult',
    'SPPROPERTYINFO', 'SpNotifyTranslator', 'SVP_13',
    'DISPID_SVDisplayUI', 'eLEXTYPE_PRIVATE2', 'DISPID_SOTs_NewEnum',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SMSSetData',
    'SAFT24kHz8BitMono', 'SAFT32kHz8BitStereo', 'SDKLLocalMachine',
    'SVSFNLPSpeakPunc', 'SpAudioFormat', 'ISpeechPhraseAlternate',
    'ISpeechPhraseProperty', 'SPEI_END_INPUT_STREAM',
    'DISPID_SDKCreateKey', 'ISpEventSource', 'SpFileStream',
    'DISPID_SRGCommit', 'SAFTCCITT_ALaw_44kHzStereo',
    'SPCONTEXTSTATE', 'DISPID_SPEsItem', 'SVF_Emphasis',
    'DISPID_SPRuleFirstElement', 'DISPID_SRCEPhraseStart',
    'DISPID_SBSFormat', 'ISpGrammarBuilder', 'SVF_None',
    'DISPID_SDKSetLongValue', 'eLEXTYPE_PRIVATE19',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SGRName',
    'SpeechTokenKeyAttributes', 'DISPID_SRGState',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SGRSTs_NewEnum',
    'ISpeechPhraseInfoBuilder', 'DISPID_SpeechPhraseInfo',
    'DISPID_SVEVoiceChange', 'SPLO_STATIC',
    'SpeechAudioFormatGUIDText', 'ISpeechXMLRecoResult',
    'DISPID_SGRsItem', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SAVolume', 'DISPID_SVSpeakCompleteEvent', 'SVEViseme',
    'tagSPTEXTSELECTIONINFO', 'SVP_18', 'eLEXTYPE_PRIVATE18',
    'SPEI_RECO_STATE_CHANGE', 'SPEI_MAX_SR',
    'SAFTCCITT_ALaw_8kHzMono', 'SpResourceManager',
    'DISPID_SRSCurrentStreamPosition', 'ISpPhoneticAlphabetSelection',
    'SPPS_RESERVED3', 'SRADynamic', 'SPEI_RESERVED1',
    'SpeechTokenContext', 'DISPID_SREmulateRecognition',
    'SpeechWordType', 'SP_VISEME_1', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SVSInputSentenceLength', 'DISPID_SGRSTPropertyName',
    'DISPID_SVGetAudioInputs', 'SSFMCreate', 'SP_VISEME_4',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SAFT16kHz8BitMono',
    'SPPS_SuppressWord', 'ISpeechGrammarRule', '_SPAUDIOSTATE',
    'DISPID_SRGCmdLoadFromResource', 'STCInprocServer',
    'SpeechVoiceEvents', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SPRules_NewEnum', 'DISPID_SVEWord', 'DISPID_SPIGetText',
    'SPSSuppressWord'
]

_check_version('1.2.1', 1700150430.519060)
